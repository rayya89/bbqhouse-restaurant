...
export default function UpdateProduct({ formState, listState, item, categoryId }) {
...
if (!showForm) return null;
  ...
  return (
    ...
    <section className="create-product">
      ...
      <InputField setup={addProduct.shortDescription} state={[shortDescription,setShortDescription]}/>
      <InputField setup={addProduct.longDescription} state={[longDescription,setLongDescription]}/>
      <InputField setup={addProduct.ingredients} state={[ingredients,setIngredients]}/>
      <InputField setup={addProduct.price} state={[price,setPrice]}/>
      <InputField setup={addProduct.thumbnail} state={[thumbnail,setThumbnail]}/>
      <InputField setup={addProduct.imageURL} state={[imageURL,setimageURL]}/>
